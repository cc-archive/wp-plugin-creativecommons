import './style.scss';
import './editor.scss';
import globals from 'ccGlobal'; // Updated global import
 ...
 */
registerBlockType('cc/cc-by-sa', { // Updated block name
    title: __('CC-BY-SA'),
    icon: 'media-text',
    ...
    attributes: {
        ...
        contentName: {
            selector: '.cc-cgb-name', // Update class selector if needed
            source: 'children'
        },
        contentText: {
            selector: '.cc-cgb-text', // Update class selector if needed
            source: 'children'
        }
    },
